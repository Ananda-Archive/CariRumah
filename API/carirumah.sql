...
--
ALTER TABLE mitra INTEGER NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE products INTEGER NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `products_image`
--
ALTER TABLE products_image INTEGER NOT NULL AUTO_INCREMENT;
