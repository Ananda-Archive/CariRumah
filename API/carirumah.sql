...
--
ALTER TABLE agent INTEGER NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `article`
--
ALTER TABLE article INTEGER NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mitra`
--
ALTER TABLE mitra INTEGER NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE products INTEGER NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `products_image`
--
ALTER TABLE products_image INTEGER NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;
